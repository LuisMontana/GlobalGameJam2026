	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float lerpResult83 = lerp( irisScale208 , ( irisScale208 * (( _UseDepth )?( ( _PupilScale * ( 0.2 / ( 0.2 + irisDepth219 ) ) ) ):( _PupilScale )) ) , irisDepthMask412);
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;69;-7040,-1136;Inherit;False;Constant;_DepthCorrection;Depth Correction;7;0;Create;True;0;0;0;False;0;False;0.2;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;212;-6144,-2192;Inherit;False;203;radial;1;0;OBJECT;;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=B3F446A20BDB9B24762CE91585425535E5094955